    ...
    <section className="hero shell">
      ...
      <div className="hero-visual hero-visual-reference">
        <div className="hero-reference-card">
          <div className="reference-browser-bar">
            <span className="reference-dot" />
            <span className="reference-dot" />
            <span className="reference-dot" />
            <div className="reference-search">Operational dashboard preview</div>
          </div>
          <div className="reference-image-wrap">
            <img
              src="/hero-dashboard-reference.png"
              alt="Korvist dashboard preview"
              className="reference-image"
            />
          </div>
          <div className="reference-float reference-float-left">
            <span>Deployment Readiness</span>
            <strong>96%</strong>
            <p>Design, rollout, and monitoring aligned.</p>
          </div>
          <div className="reference-float reference-float-right">
            <span>Live Metrics</span>
            <strong>24/7</strong>
            <p>Operational visibility across teams and systems.</p>
          </div>
        </div>
      </div>
    </section>
